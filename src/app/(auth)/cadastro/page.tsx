  ...
  return (
    <>
      ...
      <form action={signUpAction} className="mt-7 grid gap-4 sm:grid-cols-2">
        ...
        <button className="flex h-12 items-center justify-center gap-2 rounded-xl bg-brand text-sm font-bold text-white hover:bg-brand-strong sm:col-span-2">Criar minha conta<ArrowRight className="size-4" /></button>
      </form>
